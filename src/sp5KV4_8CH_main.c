 ...
 *
 * SP5KV4_8CH:
 * Adaptacion del sp5KV4 a 8 canales para UTE.
 * 1- Elimino todo lo referente a las consignas.
 * 2- Elimino el pwrSave
 * 3- El sistema funciona solo en modo continuo.
 * 4- La terminal siempre esta prendida.
 * 5- No necesito salir automaticamente del modo service.
 * 6- Uso solo 4 entradas analogicas D0..D3
 * 7- Elimino el roaming
 * 8- Debido al hardware de pulsos, solo contamos pulsos pero no niveles.
...
static void pv_initMPU(void)
{
	...
	// Leds ( salidas)
	sbi( LED_KA_DDR, LED_KA );
	sbi( LED_MODEM_DDR, LED_MODEM );
